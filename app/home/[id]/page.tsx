...
import { ReservationSubmitButton } from '@/app/components/CreationSubmit';
  ...
  return (
    <div className='w-[75%] mx-auto mt-10 mb-12'>
        ...
        <div className='relative h-[550px]'>
            <Image 
                alt='home-image'
                src={`https://bjehpomukrxfrykdjpnh.supabase.co/storage/v1/object/public/airbnb-images/${data?.photo}`}
                fill
